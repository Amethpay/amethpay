...
import 'tranfer_crypto_computer_model.dart';
export 'tranfer_crypto_computer_model.dart';

class TranferCryptoComputerWidget extends StatefulWidget {
  const TranferCryptoComputerWidget({super.key});

  @override
  State<TranferCryptoComputerWidget> createState() =>
      _TranferCryptoComputerWidgetState();
}

class _TranferCryptoComputerWidgetState
    extends State<TranferCryptoComputerWidget> with TickerProviderStateMixin {
  late TranferCryptoComputerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranferCryptoComputerModel());
