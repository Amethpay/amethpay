...
import 'tranfer_crypto_model.dart';
export 'tranfer_crypto_model.dart';

class TranferCryptoWidget extends StatefulWidget {
  const TranferCryptoWidget({super.key});

  @override
  State<TranferCryptoWidget> createState() => _TranferCryptoWidgetState();
}

class _TranferCryptoWidgetState extends State<TranferCryptoWidget>
    with TickerProviderStateMixin {
  late TranferCryptoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranferCryptoModel());
