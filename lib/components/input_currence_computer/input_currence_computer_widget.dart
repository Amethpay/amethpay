...
import 'input_currence_computer_model.dart';
export 'input_currence_computer_model.dart';

class InputCurrenceComputerWidget extends StatefulWidget {
  const InputCurrenceComputerWidget({super.key});

  @override
  State<InputCurrenceComputerWidget> createState() =>
      _InputCurrenceComputerWidgetState();
}

class _InputCurrenceComputerWidgetState
    extends State<InputCurrenceComputerWidget> with TickerProviderStateMixin {
  late InputCurrenceComputerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputCurrenceComputerModel());
