...
class UsersRecord extends FirestoreRecord {
  ...
  // "BalanceBitcoin" field.
  double? _balanceBitcoin;
  double get balanceBitcoin => _balanceBitcoin ?? 0.0;
  bool hasBalanceBitcoin() => _balanceBitcoin != null;

  // "BalanceEthereum" field.
  double? _balanceEthereum;
  double get balanceEthereum => _balanceEthereum ?? 0.0;
  bool hasBalanceEthereum() => _balanceEthereum != null;

  // "BalanceSolana" field.
  double? _balanceSolana;
  double get balanceSolana => _balanceSolana ?? 0.0;
  bool hasBalanceSolana() => _balanceSolana != null;

  // "BalanceLiteCoin" field.
  double? _balanceLiteCoin;
  double get balanceLiteCoin => _balanceLiteCoin ?? 0.0;
  bool hasBalanceLiteCoin() => _balanceLiteCoin != null;

  // "BalanceUSDT" field.
  double? _balanceUSDT;
  double get balanceUSDT => _balanceUSDT ?? 0.0;
  bool hasBalanceUSDT() => _balanceUSDT != null;

  // "HomeTotalZloty" field.
  double? _homeTotalZloty;
  double get homeTotalZloty => _homeTotalZloty ?? 0.0;
  bool hasHomeTotalZloty() => _homeTotalZloty != null;

  // "HomeZloty" field.
  double? _homeZloty;
  double get homeZloty => _homeZloty ?? 0.0;
  bool hasHomeZloty() => _homeZloty != null;

  // "HomeEuro" field.
  double? _homeEuro;
  double get homeEuro => _homeEuro ?? 0.0;
  bool hasHomeEuro() => _homeEuro != null;

  // "HomeDollar" field.
  double? _homeDollar;
  double get homeDollar => _homeDollar ?? 0.0;
  bool hasHomeDollar() => _homeDollar != null;

  // "copyofpassportbusiness" field.
  String? _copyofpassportbusiness;
  ...
  void _initializeFields() {
    ...
    _balanceBitcoin = castToType<double>(snapshotData['BalanceBitcoin']);
    _balanceEthereum = castToType<double>(snapshotData['BalanceEthereum']);
    _balanceSolana = castToType<double>(snapshotData['BalanceSolana']);
    _balanceLiteCoin = castToType<double>(snapshotData['BalanceLiteCoin']);
    _balanceUSDT = castToType<double>(snapshotData['BalanceUSDT']);
    _homeTotalZloty = castToType<double>(snapshotData['HomeTotalZloty']);
    _homeZloty = castToType<double>(snapshotData['HomeZloty']);
...
Map<String, dynamic> createUsersRecordData({
  ...
  String? firstName,
  String? lastName,
  double? balanceBitcoin,
  double? balanceEthereum,
  double? balanceSolana,
  double? balanceLiteCoin,
  double? balanceUSDT,
  double? homeTotalZloty,
  double? homeZloty,
  double? homeEuro,
  double? homeDollar,
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'BalanceSolana': balanceSolana,
      'BalanceLiteCoin': balanceLiteCoin,
      'BalanceUSDT': balanceUSDT,
      'HomeTotalZloty': homeTotalZloty,
      'HomeZloty': homeZloty,
      'HomeEuro': homeEuro,
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.displayName == e2?.displayName &&
        ...
        e1?.balanceBitcoin == e2?.balanceBitcoin &&
        e1?.balanceEthereum == e2?.balanceEthereum &&
        e1?.balanceSolana == e2?.balanceSolana &&
        e1?.balanceLiteCoin == e2?.balanceLiteCoin &&
        e1?.balanceUSDT == e2?.balanceUSDT &&
        e1?.homeTotalZloty == e2?.homeTotalZloty &&
