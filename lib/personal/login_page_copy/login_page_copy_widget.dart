...
class LoginPageCopyWidget extends StatefulWidget {
  ...
  static String routePath = '/loginPageTeste';
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ajm1to6p' /* Login to access your account b... */,
                                              ),
                                              style:
                                                          ...
                                                          .authenticate(
                                                              localizedReason:
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                    'hxecvwb3' /* biometrics recognition */,
                                                  ));
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '611g54rl' /* Don't have an account? */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'f27e4vuq' /* Login to access your account b... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleMedium
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '2zjlt0pv' /* Don't have an account? */,
                                                            ),
