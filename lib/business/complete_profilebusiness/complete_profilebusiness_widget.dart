...
import 'complete_profilebusiness_model.dart';
export 'complete_profilebusiness_model.dart';

class CompleteProfilebusinessWidget extends StatefulWidget {
  const CompleteProfilebusinessWidget({
    super.key,
    required this.email,
  ...
  @override
  State<CompleteProfilebusinessWidget> createState() =>
      _CompleteProfilebusinessWidgetState();
}

class _CompleteProfilebusinessWidgetState
    extends State<CompleteProfilebusinessWidget> with TickerProviderStateMixin {
  late CompleteProfilebusinessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompleteProfilebusinessModel());
